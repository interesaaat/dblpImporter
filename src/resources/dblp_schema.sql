...
CREATE  TABLE IF NOT EXISTS author_a (  person_id INT(11)  NULL DEFAULT NULL ,  article_id INT(11) NULL DEFAULT NULL ) ENGINE = MyISAM DEFAULT CHARACTER SET = utf8;
...
CREATE  TABLE IF NOT EXISTS author_b (  person_id INT(11)  NULL DEFAULT NULL ,  book_id INT(11)  NULL DEFAULT NULL ) ENGINE = MyISAM DEFAULT CHARACTER SET = utf8;
...
CREATE  TABLE IF NOT EXISTS author_c (  person_id INT(11) NULL DEFAULT NULL ,  in_coll_id INT(11)  NULL DEFAULT NULL ) ENGINE = MyISAM DEFAULT CHARACTER SET = utf8;
...
CREATE  TABLE IF NOT EXISTS author_i (  person_id INT(11)  NULL DEFAULT NULL ,  in_proc_id INT(11)  NULL DEFAULT NULL ) ENGINE = MyISAM DEFAULT CHARACTER SET = utf8;
...
CREATE  TABLE IF NOT EXISTS author_w (  person_id INT(11)  NULL DEFAULT NULL ,  www_id INT(11)  NULL DEFAULT NULL ) ENGINE = MyISAM DEFAULT CHARACTER SET = utf8;
...
CREATE  TABLE IF NOT EXISTS editor_p (  person_id INT(11)  NULL DEFAULT NULL ,  proc_id INT(11) NULL DEFAULT NULL ) ENGINE = MyISAM DEFAULT CHARACTER SET = utf8;
...
CREATE  TABLE IF NOT EXISTS master_thesis (  id INT(11)  NULL DEFAULT NULL ,  thesis_id VARCHAR(50) NULL DEFAULT NULL ,  title TEXT NULL DEFAULT NULL ,  ee TEXT NULL DEFAULT NULL ,  year VARCHAR(11) NULL DEFAULT NULL ,  url TEXT NULL DEFAULT NULL ,  author_id INT(11) NULL DEFAULT NULL ) ENGINE = MyISAM DEFAULT CHARACTER SET = utf8;
...
CREATE  TABLE IF NOT EXISTS person (  id INT(11) NULL DEFAULT NULL ,  name TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  phone TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  email TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  homepage TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  affiliation TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  address TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  bio TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  position TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  phd_univ TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  phd_major TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  phd_date TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  ms_univ TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  ms_major TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  ms_date TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  bs_univ TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  bs_major TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL ,  bs_date TEXT CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL  ) ENGINE = MyISAM DEFAULT CHARACTER SET = utf8 COLLATE = utf8_unicode_ci;
...
CREATE  TABLE IF NOT EXISTS phd_thesis (  id INT(11)  NULL DEFAULT NULL ,  thesis_id VARCHAR(50) NULL DEFAULT NULL ,  title TEXT NULL DEFAULT NULL ,  volume TEXT NULL DEFAULT NULL ,  number TEXT NULL DEFAULT NULL ,  ee TEXT NULL DEFAULT NULL ,  year VARCHAR(11) NULL DEFAULT NULL ,  url TEXT NULL DEFAULT NULL ,  publisher TEXT NULL DEFAULT NULL ,  school TEXT NULL DEFAULT NULL ,  month TEXT NULL DEFAULT NULL ,  note TEXT NULL DEFAULT NULL ,  isbn TEXT NULL DEFAULT NULL ,  author_id INT(11) NULL DEFAULT NULL  ) ENGINE = MyISAM DEFAULT CHARACTER SET = utf8;
